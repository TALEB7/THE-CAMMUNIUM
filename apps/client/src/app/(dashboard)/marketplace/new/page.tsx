  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="flex items-center gap-3">
        <Link href="/marketplace" className="rounded-lg border p-2 hover:bg-gray-50">
          <ArrowLeft className="h-4 w-4" />
        </Link>
        <div>
          <h1 className="text-2xl font-extrabold text-[#1a237e] font-heading tracking-wide">Publier une annonce</h1>
          <p className="text-sm text-gray-500">Remplissez les informations de votre annonce</p>
        </div>
      </div>
